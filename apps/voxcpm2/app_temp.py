...
class VoxCPMDemo:
    def __init__(self, model_id: str = "openbmb/VoxCPM2") -> None:
        ...
        self.asr_model_id = "./tmp_modelscope_cache/models/iic/SenseVoiceSmall"
    ...
    with gr.Blocks() as interface:
        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Row():
                    load_ref_btn = gr.Button("reference_speaker.wav")
                    load_example_btn = gr.Button("example.wav")
        ...
        load_ref_btn.click(
            fn=lambda: "examples/reference_speaker.wav",
            inputs=[],
            outputs=[reference_wav],
        )

        load_example_btn.click(
            fn=lambda: "examples/example.wav",
            inputs=[],
            outputs=[reference_wav],
        )
