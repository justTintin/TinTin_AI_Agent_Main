...
from utils.http_client import http_post, resilient_post
...
def _read_vox_url() -> str:
    """从 ai_config 读 vox_api_url。优先 vox_api_url，否则从 compute_server_url + /voxcpm/tts 派生。"""  # noqa: E501
    try:
...
def synthesize_tts(text: str, ref_wav: str = "", out_path: str = "",
    ...
    try:
        ...
        raise ApiError(url, method="POST", params=payload, cause=e, service="voxcpm") from e
