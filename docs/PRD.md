...
```
基础版（免费）      智能混剪 + 绑定1个抖音号
  └─ 标准版（付费）  + 素材管理 + AI分析 + 文案创作 + 绑定3个平台账号
       └─ 旗舰版（高价）+ 数据看板 + 全平台分发 + 数字人 + 工具类 + 绑定无限账号
```
...
| 基础版 | 1 个 | 仅抖音 |
| 标准版 | 3 个 | 抖音 + 任选2平台 |
| 旗舰版 | 不限 | 全平台（抖音/小红书/B站/快手/视频号/YouTube） |

### 功能映射（Feature Flag）
| Flag | 版本 | 功能 |
|---|---|---|
| `clip` | 基础 | 智能混剪、一键成片、直播切片 |
| `material` | 标准 | 素材管理、向量检索、任务列表、素材浏览器 |
