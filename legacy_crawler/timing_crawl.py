import time
from core.crawlers import Crawlers
import configparser
...
for keyword in keywords_chinese.split(','):
    try:
        ...
        if crawlers_config.get('Toutiao_crawler') == 'True' or crawlers_config.get('Toutiao_crawler') is True:
            print(f'开启toutiao爬虫...')
            crawler.toutiao_crawler(keyword)
        time.sleep(10)
