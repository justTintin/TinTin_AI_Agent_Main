...
在开始本教程之前，建议先了解[PaddleOCR模型的训练方法](../model_train/training.md)以及[PaddleSlim](https://github.com/PaddlePaddle/PaddleSlim/blob/develop/README.md)
...
量化模型移动端部署的可参考 [移动端模型部署](../../../../deploy/lite/readme_ch.md)
